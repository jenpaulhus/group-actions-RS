...
def create_list():
    ...
    Each element of gps_transitive is [gapidfull, nTt, n, gens], where nTt, 
      generated by gens, is a transitive subgroup of Sn of minimal n isomorphic
      to gapidfull.
    For solvable groups that are nonabelian or abelian and of order <= the max
      abelian order of groups in the db, this transitive subgroup is passed into
      RepEpi.
    '''
